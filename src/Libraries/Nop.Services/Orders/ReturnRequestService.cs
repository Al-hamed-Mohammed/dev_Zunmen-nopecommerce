...
namespace Nop.Services.Orders
{
    ...
    public partial class ReturnRequestService : IReturnRequestService
    {
        ...
        public IPagedList<ReturnRequest> SearchReturnRequests(int vendorID, int storeId = 0, int customerId = 0,
            ...
            DateTime? createdToUtc = null, int pageIndex = 0, int pageSize = int.MaxValue, bool getOnlyTotalCount = false)
        {
            var query = from rr in _returnRequestRepository.Table
                        join ot in _orderitemRepository.Table on rr.OrderItemId equals ot.Id
                        join p in _productRepository.Table on ot.ProductId equals p.Id
