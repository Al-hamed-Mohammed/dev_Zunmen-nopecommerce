...
namespace Nop.Web.Areas.Admin.Factories
{
    ...
    public partial class CommonModelFactory : ICommonModelFactory
    {
        ...
        public virtual CommonStatisticsModel PrepareCommonStatisticsModel()
        {
            ...
            {
                model.NumberOfPendingReturnRequests = _returnRequestService.SearchReturnRequests(vendorID: 0, rs: returnRequestStatus,
               pageIndex: 0, pageSize: 1, getOnlyTotalCount: true).TotalCount;
            }
            else
            {
                model.NumberOfPendingReturnRequests = _returnRequestService.SearchReturnRequests(vendorID: _workContext.CurrentVendor.Id, rs: returnRequestStatus,
              pageIndex: 0, pageSize: 1, getOnlyTotalCount: true).TotalCount;
            }
