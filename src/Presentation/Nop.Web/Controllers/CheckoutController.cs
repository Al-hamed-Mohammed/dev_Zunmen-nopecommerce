...
namespace Nop.Web.Controllers
{
    ...
    public partial class CheckoutController : BasePublicController
    {
        ...
        public virtual IActionResult Completed(int? orderId)
        {
            ...
            {
                if(item.Product.Name == WalletProduct.PRODUCT 
                    && _workContext.CurrentVendor != null
                    && item.Product.SubjectToAcl == true)
                {
                    if(wallet != null)
                    {
                        wallet.Amount += item.PriceInclTax;
                    ...
                    // Insert the Details Record to WalletDetail Table

                    var walletdetail = new WalletDetail
                    {
                        WalletID = wallet.Id,
                        Description = "OrderID- " + order.Id + " Details- " + item.Product.Name + " product purchased",
                        DateCreated = DateTime.Now,
                        Amount = item.PriceInclTax,
                        AmountAdded = true,
                    ...
                    // Now Update Orders Table to store Wallet ID to order
            ...
            // Wallet Details Insert End here
