    ...
    public partial class CustomerController : BasePublicController
    {
        ...
        public virtual IActionResult Register(RegisterModel model, string returnUrl, bool captchaValid, IFormCollection form)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                // Customer and Vendor Role Registretion
                var registrationResult = new CustomerRegistrationResult();
                if (returnUrl.Trim() == "/vendor/apply")
                {
                    registrationResult = _vendorRegistrationService.RegisterCustomer(registrationRequest, returnUrl);
                }
                else
                {
