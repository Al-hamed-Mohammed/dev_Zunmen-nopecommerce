...
namespace Nop.Web.Infrastructure
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<VendorRegistrationService>().As<IVendorRegistrationService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<WalletDetailService>().As<IWalletDetailService>().InstancePerLifetimeScope();
        }
